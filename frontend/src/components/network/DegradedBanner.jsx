        ...
        >
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xs font-black text-status-warning uppercase tracking-widest">
                Infrastructure Alert: Real-time Telemetry Degraded
              </span>
            </div>
            
            <div className="flex items-center space-x-6">
              <p className="text-xs text-text-secondary font-bold uppercase tracking-tighter">
              ...
              >
                ...
                <span className="text-xs font-black text-status-warning uppercase">Refresh Stream</span>
              </button>
            </div>
          </div>
        </motion.div>
