      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div ref={textRef} className="max-w-xl">
          ...
          <div className="overflow-hidden mb-8">
            <p className="hero-text-line text-base lg:text-lg text-text-secondary leading-relaxed max-w-lg">
              Cryptographically secure distributed file architecture. Built for scale, engineered for absolute privacy with multi-provider redundancy.
            </p>
          </div>
          ...
          {/* Trust Metrics */}
          <div className="mt-12 flex items-center space-x-8 border-t border-white/10 pt-6">
            <div>
              <div className="text-xl font-bold text-white mb-0.5">99.99%</div>
              <div className="text-[10px] text-text-secondary uppercase tracking-widest">Uptime SLA</div>
            </div>
            <div className="w-px h-8 bg-white/10" />
            <div>
              <div className="text-xl font-bold text-white mb-0.5">&lt;50ms</div>
              <div className="text-[10px] text-text-secondary uppercase tracking-widest">Latency</div>
            </div>
            <div className="w-px h-8 bg-white/10" />
            <div>
              <div className="text-xl font-bold text-white mb-0.5">AES-256</div>
              <div className="text-[10px] text-text-secondary uppercase tracking-widest">Secure</div>
            </div>
          </div>
        </div>

        {/* RIGHT COLUMN: Node Visualization */}
        <div className="relative h-[450px] hidden lg:block" ref={graphRef}>
