...
from app.api.deps import get_async_session, get_admin_user
...
async def get_node_health(current_user=Depends(get_admin_user), session: AsyncSession = Depends(get_async_session)) -> List[NodeHealthResponse]:
